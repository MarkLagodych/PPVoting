 ...
 *       3* интерактивно настраиваться по последовательному порту      *
 *                                                                     *
 ...
 *    Подробный результат - это список пар вида                        *
 *        "IP-адрес", "Выбранный вариант".                             *
 * 4* При "q" - входить, при "e" - выходить из режима настройки        *
 *    Следующие за "q" команды:                                        *
 *    gX        -- (get) получить настройку Х                          *
 *    sXABCD... -- (set) изменить настройку Х на ABCD...               *
 *    rX        -- (reset) установить значение по умолчанию            *
 *                                                                     *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
