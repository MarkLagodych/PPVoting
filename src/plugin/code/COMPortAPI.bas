...
'###############################################
'# Modified by: Lagodych Mark                  #
'# New:                                        #
'#  1. You can use more than 4 COM ports       #
'#  2. VBA7's PtrSafe is included              #
'###############################################
...
#If VBA7 Then
    ...
    Declare PtrSafe Function CreateFile Lib "kernel32" Alias "CreateFileA" _
        (ByVal lpFileName As String, ByVal dwDesiredAccess As LongPtr, _
        ByVal dwShareMode As LongPtr, lpSecurityAttributes As Any, _
        ByVal dwCreationDisposition As LongPtr, ByVal dwFlagsAndAttributes As LongPtr, _
    ...
    Declare PtrSafe Function EscapeCommFunction Lib "kernel32" _
        (ByVal nCid As LongPtr, ByVal nFunc As LongPtr) As Long
    '
    ...
    Declare PtrSafe Function FormatMessage Lib "kernel32" Alias "FormatMessageA" _
        (ByVal dwFlags As LongPtr, lpSource As Any, ByVal dwMessageId As LongPtr, _
        ByVal dwLanguageId As LongPtr, ByVal lpBuffer As String, ByVal nSize As LongPtr, _
    ...
    Declare PtrSafe Function GetOverlappedResult Lib "kernel32" _
        ...
        lpNumberOfBytesTransferred As Long, ByVal bWait As LongPtr) As Long
    '
    ...
    Declare PtrSafe Function PurgeComm Lib "kernel32" _
        (ByVal hFile As LongPtr, ByVal dwFlags As LongPtr) As Long
    '
    ...
    Declare PtrSafe Function ReadFile Lib "kernel32" _
        ...
        ByVal nNumberOfBytesToRead As LongPtr, ByRef lpNumberOfBytesRead As Long, _
    ...
    Declare PtrSafe Function SetupComm Lib "kernel32" _
        (ByVal hFile As LongPtr, ByVal dwInQueue As LongPtr, ByVal dwOutQueue As LongPtr) As Long
    '
    ...
    Declare PtrSafe Function WriteFile Lib "kernel32" _
        (ByVal hFile As LongPtr, ByVal lpBuffer As String, _
        ByVal nNumberOfBytesToWrite As LongPtr, lpNumberOfBytesWritten As Long, _
        lpOverlapped As OVERLAPPED) As Long
